...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        self.long_url_in.grid(row=1, column=0, padx=0, pady=6)
        ...
        self.shrinkButton.grid(row=2, column=0, padx=0, pady=5)
    ...
    def get_url(self):
        ...
        self.shrinked_url = shortner.select_host(host='cuttly', url=self.long_url_str)
